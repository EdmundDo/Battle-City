...
public:
     //constructor
    Obstacle(int x, int y, int width, int height, Color color, Terrain a);
...
public:
    ...
    //constructor
    DestructibleObstacle(int x, int y, int width, int height, Color color, Terrain a, double health);
